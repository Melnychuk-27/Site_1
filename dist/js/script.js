...
//     carusel__item[idx].style.display = 'none'; // Скрываем текущий слайд
//     carusel__item[++idx].style.display = 'block'; // Инкрементируем индекс и показываем следующий слайд
...
//     carusel__item[idx].style.display = 'none';
//     carusel__item[--idx].style.display = 'block';
//     if (idx === 0) {
